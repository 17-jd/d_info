...
- **1,043 unique, source-verified leads** across **23 Surat business segments**.
- **805 are tagged `SME - direct`** — small / owner-run businesses a small
...
- **Tiers:** 241 Tier-A · 589 Tier-B · 213 Tier-C.
...
| **`data/leads_master.csv`** | All 1,043 leads incl. the big/tender/chain ones (tagged in `supplier_fit`), de-duplicated, scored, tiered, sorted. Columns for *who to contact / why / what they need*. | Full picture; filter by `supplier_fit`, category or area. |
